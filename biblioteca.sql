...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2021 a las 18:25:09
...
(27, 'Harry Potter y la Piedra Filosofal', 'J K Rowling', 'Harry Potter ni siquiera ha oído hablar de Hogwarts cuando las letras comienzan a caer sobre el felpudo del número cuatro, Privet Drive. Reda....', '1615994456_aa9a0dbdf064d9803095.jfif', 'Harry Potter ni siquiera ha oído hablar de Hogwarts cuando las letras comienzan a caer sobre el felpudo del número cuatro, Privet Drive. Redactados en tinta verde sobre pergamino amarillento con un sello púrpura, son rápidamente confiscados por su espeluznante tía y tío. Luego, en el undécimo cumpleaños de Harry, un gran gigante de ojos de escarabajo llamado Rubeus Hagrid irrumpe con una noticia asombrosa: Harry Potter es un mago y tiene un lugar en el Colegio Hogwarts de Magia y Hechicería.', '9788478884452', 'Bloomsbury Publishing', 223, 'Scholastic Corporation', 'España', '1998');
...
INSERT INTO `t_usuario` (`id_usuario`, `usuario`, `password`, `type`) VALUES
(1, 'admin', '$2y$10$HoFLzNL9iLbE5BeDtBLWruDchMh6bzUi6msmqBKmJTwg3WgkFo/a.', 'admin'),
(3, 'Ashanty', '$2y$10$0V1bjpFf2wSfnP1m1CNPFOlZ2cZip8G8Tu2DrPTfznvCGJgfiZ5Yy', 'admin'),
(4, 'Esdras', '$2y$10$A8pt6bkF66cCe7mFC9iz3.RuOZsfKh9fDBG53UMgB/LCF4zlbi5oy', 'admin');
...
--
ALTER TABLE `t_usuario`
  MODIFY `id_usuario` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
